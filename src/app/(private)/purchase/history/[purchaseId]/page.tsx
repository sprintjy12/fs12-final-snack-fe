...
export default function PurchaseHistoryDetailPage() {
  ...
  const { data, isPending, isError, error } = useOrderDetail(purchaseId);
            ...
            <div className="flex h-[356px] flex-col px-6 py-6 md:mt-8 md:h-[308px] md:py-0 xl:mt-4 xl:h-[358px] xl:px-0">
              ...
              <div className="mt-3 flex flex-1 flex-col gap-3 border-t border-snack-black-100 pt-3 xl:mt-4 xl:gap-4 xl:pt-4">
                ...
                <div>
                  ...
                  <div className="mt-4 flex min-h-[52px] items-center rounded-2xl border border-border bg-surface-muted px-4 py-3 text-sm leading-6 whitespace-pre-line text-foreground-muted xl:min-h-[54px] xl:px-6 xl:text-lg xl:leading-[26px]">
