...
import { parseOptionalId } from "@/lib/parseOptionalId";
...
export function Header({
  ...
  const resolvedCartCount =
    typeof cartCount === "number" && Number.isFinite(cartCount)
  ...
  const subCategoryId = parseOptionalId(searchParams.get("subCategoryId"));
